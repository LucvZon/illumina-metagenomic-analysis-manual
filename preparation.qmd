...
1.  Copy the Code: Copy the above text and save it to a file named environment.yml in your project directory.

2.  Create the Environment: In your terminal, navigate to your project directory (where you saved the environment.yml file) and run the following command:
